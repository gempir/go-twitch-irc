		...
		},
		{
			...
			PrivateMessage{
				...
				Source: &Source{
					...
					RoomID:     "39656772",
					ID:         "614e293b-46c8-4f6f-9e35-f53f64254472",
					SourceOnly: false,
				},
			},
		},
		{
			"Message from shared chat",
			"@badge-info=;badges=moderator/1;color=#00FF7F;display-name=Eternalwerecat22;emotes=;flags=;id=fa9da65d-86da-429f-90f1-467a6ac332df;mod=1;room-id=39656772;source-badge-info=subscriber/5;source-badges=subscriber/3;source-id=614e293b-46c8-4f6f-9e35-f53f64254472;source-only=0;source-room-id=655533779;subscriber=0;tmi-sent-ts=1762536730215;turbo=0;user-id=488149571;user-type=mod :eternalwerecat22!eternalwerecat22@eternalwerecat22.tmi.twitch.tv PRIVMSG #vampireblazewing :Video game things",
			PrivateMessage{
				User: User{
					ID:          "488149571",
					Name:        "eternalwerecat22",
					DisplayName: "Eternalwerecat22",
					Color:       "#00FF7F",
					Badges: map[string]int{
						"moderator": 1,
					},
				...
				Type:           PRIVMSG,
				RawType:        "PRIVMSG",
				Message:        "Video game things",
				Channel:        "vampireblazewing",
				RoomID:         "39656772",
				ID:             "fa9da65d-86da-429f-90f1-467a6ac332df",
				FirstMessage:   false,
